...
def run(contact_name: str, query: str, top_k: int = 3, vertical_id: Optional[str] = None) -> Dict[str, Any]:
    ...
    snippets = mem0_backend.retrieve(contact_name=contact_name, query=query, top_k=int(top_k), vertical_id=vertical_id)
